...
String Db_password = "Create@1234";
     try{
		...
		while(rs.next()) {
			%>
			<tr> 
			   <td><%=rs.getInt("GetVotes") %></td>
			   <td><%=rs.getString("elected") %></td>
...
<% 
String result = " select count(*) as getVotes, elected from electionb group by elected order by getVotes desc limit 1;" ;
